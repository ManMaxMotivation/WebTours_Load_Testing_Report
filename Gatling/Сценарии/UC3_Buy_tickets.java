...
// - Повторение: Каждый пользователь выполнит сценарий ровно 5 раз (или укажите свое значение).
// - Пейсинг: Каждый цикл сценария занимает ровно 30 секунд (pace), добавляя паузу, если выполнение завершилось раньше.
// - Паузы: Между шагами добавлены фиксированные паузы по 3 секунды для реалистичности.

    // ⚙️ Конфигурация нагрузки: 50 пользователей за 10 секунд
